...
export default function NewItem() {
    ...
    return(
        <main>
            <div className="flex flex-col items-center justify-between font-bold text-4xl text-green-500 mt-16 mb-0">
               <h1 >Produce Selector🥦🍍</h1>
            </div>
            <div className=" flex min-h-screen flex-col items-center justify-between p-24">
            <form className=" p-2 m-2 text-black bg-orange-300 max-w-sm w-full rounded-md" onSubmit={handleSubmit}>
                ...
                <br />
                <button className="bg-green-500 w-full p-1.5 rounded-lg mb-2 text-white" type="submit">+</button>
            </form>
            </div>
        </main>
    );
